...
<MenuScreen>:
    ...
    MDFloatLayout:
        ...
        MDRaisedButton:
            ...
            size_hint: None, None
            size: "100dp", "50dp"
            pos_hint: {"center_x": .90, "center_y": .12}
...
class MenuScreen(Screen):
    ...
    def on_enter(self):
        ...
        if 'pizza_grid' in self.ids:
            ...
            self.ids.pizza_grid.add_widget(FoodCard("پیتزا مخصوص", "280000", "pizza1.png"))
            self.ids.pizza_grid.add_widget(FoodCard("پیتزا پپرونی", "240000", "pizza2.jpg"))
            self.ids.pizza_grid.add_widget(FoodCard("پیتزا سبزیجات", "150000", "pizza3.jpg"))
            self.ids.pizza_grid.add_widget(FoodCard("پیتزا گوشت", "350000", "pizza4.jpg"))
            self.ids.pizza_grid.add_widget(FoodCard("پیتزا مرغ و قارچ", "300000", "pizza5.jpg"))
        ...
        if 'burger_grid' in self.ids:
            ...
            self.ids.burger_grid.add_widget(FoodCard("دوبل برگر", "290000", "burger2.png"))
            self.ids.burger_grid.add_widget(FoodCard("هات داگ", "140000", "burger3.jpg"))
            self.ids.burger_grid.add_widget(FoodCard("استیک", "350000", "burger4.jpg"))
        ...
        if 'pasta_grid' in self.ids:
            ...
            self.ids.pasta_grid.add_widget(FoodCard("پاستا سبزیجات", "190000", "pasta3.jpg"))
